...
class DTopUpViewController: BaseViewController {
    ...
    lazy fileprivate var footnoteLabel: ParagraphLabel = {
        ...
        label.setParagraphText("1、氧育币可用于直接购买APP内虚拟内容\n2、氧育币仅限iOS系统消费，无法在其他系统使用\n3、氧育币为虚拟币，充值后的氧育币不会过期，但无法提现或转赠他人\n4、如果遇到其他问题，请和客服取得联系协同解决，客服微信：Yangyuqinzi1314    客服电话：027-87775828")
        return label
    }()
